...
{
    public class ObjetoReporteCliente
    {
        ...
        public ObjetoReporteCliente(string ruc, string documento_identidad, string usuario, string nombre, string razon_social, string tarjeta_cliente, string habitacion_asignada, int puntos_cliente, int numero_reservas)
        {
            this.ruc = ruc;
