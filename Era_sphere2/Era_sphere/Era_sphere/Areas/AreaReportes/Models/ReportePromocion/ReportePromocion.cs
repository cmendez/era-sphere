...
namespace Era_sphere.Areas.AreaReportes.Models.ReportePromocion
{
    public class ReportePromocion
    {
        ...
        public ReportePromocion(string nombre, string descripcion, int puntos_requeridos, int descuento, DateTime fecha_inicio, DateTime fecha_fin, int relacionpromocionID)
        {
            this.nombre = nombre;
